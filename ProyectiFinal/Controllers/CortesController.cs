...
namespace ProyectiFinal.Controllers
{
    public class CortesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,ImagenUrl,Description,Price")] Corte corte)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,ImagenUrl,Description,Price")] Corte corte)
        {
            if (ModelState.IsValid)
            {
